...
- The app will check for new releases on startup.
...
## 🖥️ CLI
The app can be started from PowerShell and CMD, with support for startup automation. Run with -h or --help option to get a full set of options.
```cmd
